...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aiimagegenerator
```

A live public deployment of this template is available at [https://aiimagegenerator.templates.workers.dev](https://aiimagegenerator.templates.workers.dev)
